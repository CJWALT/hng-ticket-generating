  ...
  return (
        <>
            <div className='flex jusitfy-center align-center h-auto py-[40px] sm:border-2 sm:border-red-400 md:border-blue-400 lg:border-green-400'>
                ...
                <div className="p-[24px] rounded-[12px] sm:h-[1400px] sm:max-w-[600] border-2 self-center bg-[#08252B] mx-auto w-[90%] sm:w-[75%] overflow-hidden border-[#0E464F] text-white">
                    ...
                    <div className="p-[20px] relative flex justify-center sm:w-[432px] sm:bg-bottom sm:h-[670px] curved_inward h-[600px]">
                        <div className=" sm:w-[310px] sm:h-[450px] rounded-[24px] p-4 mt-[.2rem] border-2 border-[#71A7AF] ">
                        ...
                        <Image src={attendeeDetails?.photo} alt='attendant' width={200} height={200} className="w-[70%] sm:w-[45%] h-auto object-contain rounded-[24px] border-2 border-red"/>
                        </div>
